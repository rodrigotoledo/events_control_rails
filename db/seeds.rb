...
hostel = Hostel.create(name: 'Hostel Example')
Manager.create(hostel: hostel, email: 'manager@example.com', password: 'password', password_confirmation: 'password')
Admin.create(email: 'admin@example.com', password: 'password', password_confirmation: 'password')
user = User.create(name: Faker::Name.name_with_middle, email: 'user@example.com', uid: SecureRandom.uuid,
                   password: 'password', password_confirmation: 'password')
2.times do
  event = Event.create(hostel: hostel, title: Faker::Esport.event, location: Faker::Address.full_address,
